            ...
            <nav class="menu-principal">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-content">
                        <a href="../../Expensas/Expensas.php" class="active">Ver Expensas</a>
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-content">
                        <a href="../ControlAccesos/Invitado.php">Control de Acceso</a>
                        <a href="../GesPermisos/Permisos.php">Gestionar Permisos</a>
                        <a href="Visitas.php" class="active">Registro de Visitas</a>
                    </div>
                </div>
