...
<body>
    <header>
            ...
            <nav class="menu-principal">
                <div class="dropdown">
                    ...
                    <div class="dropdown-content">
                        ...
                        <a href="historial-pagos.php">Historial</a>
                    </div>
                </div>
                <div class="dropdown">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-content">
                        <a href="control-acceso.php">Control de Acceso</a>
                        <a href="permisos.php">Gestionar Permisos</a>
                        <a href="Seguridad/ControlAccesos/Invitados.php">Registro de Visitas</a>
                    </div>
                </div>
        ...
        <div class="derecha">
            ...
            <div class="IdSession">
                <h1 class="texto" id="usuarioNombre">Juan Pérez - Lote 15</h1>
