...
export class DigitalIDServices {
  ...
  public async generateCarnet(res: Response, userDni: string) {
    ...
    const fechaMasUnAño = new Date(userMeta.createdAt)
    ...
    fechaMasUnAño.setFullYear(userMeta.createdAt.getFullYear() + 1)
  ...
  private generateCarnetPDF(
    ...
    return new Promise(async (resolve, reject) => {
      try {
        ...
        // Generar QR Code y agregarlo al PDF
        QRCode.toBuffer(carnetData.qrUrl, {
          width: 80,
          margin: 1,
          color: {
            dark: '#000000',
        ...
        // Resolver cuando el stream finaliza
        doc.on('finish', () => {
          resolve()
        })
      } catch (error) {
